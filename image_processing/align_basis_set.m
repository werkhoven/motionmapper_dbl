function [basisImages] = ...
    align_basis_set(grouping,initialPhi,segmentationOptions,nDigits,file_path,...
...
basisImages = uint8(zeros([size(initialImage) L]));
...
for j=2:L
    ...
    originalImage = bufferEdgeFrames(originalImage,imageThreshold);
